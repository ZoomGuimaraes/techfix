...
class ServicesOrderServicesRelationManager extends RelationManager
{
    protected static string $relationship = 'servicesOrderServices';

    protected static ?string $relatedResource = ServiceOrderResource::class;

    protected static ?string $title = 'Serviços da OS';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('service.description')->label('Descrição'),
                // ...
            ])
            ->headerActions([
                CreateAction::make(),
